...
-- set track number in playlist to 1, save it
reaper.SetExtState(script_name, "joovs_playlist_index", "1", false)
track_number_in_playlist = 1						-- we set to 1 as this is the first track in playlist
